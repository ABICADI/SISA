...
@section('action-content')
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('report-paciente.search') }}">
        {{ csrf_field() }}
        @component('layouts.esconder_info')
        <table class="table responsive">
        		...
        		<td>
        			...
        			<div class="col-md-5">
        					<div class="input-group date">
        							...
        							<input type="text" name="from" class="form-control pull-right" id="from" placeholder="Fecha Ingreso">
        					</div>
        			</div>
        		</td>
        		<td>
        			...
        			<div class="col-md-5">
        					<div class="input-group date">
        							...
        							<input type="text" name="to" class="form-control pull-right" id="to" placeholder="Fecha Ingreso">
        					</div>
        			</div>
        		</td>
        	</tr>
          ...
          <tr>
            <td>
        		...
        		<td>
        			<label class="col-md-2 control-label" align="center">Tipo de Pago</label>
        			<div class="col-md-5">
        				<select class="form-control" name="pago_id" id='pago_id' autofocus>
        					<option value="0">Ningun Tipo de Pago</option>
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width = "30%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">Nombre Completo del Paciente</th>
              </tr>
            </thead>
            <tbody>
