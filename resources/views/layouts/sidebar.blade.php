  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('tratamiento-management.index') }}"><i class="fa fa-hospital-o"></i> <span>Tratamiento</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('system-management/report-tratamiento') }}"><i class=""></i> Reporte Tratamiento</a></li>
          </ul>
        </li>
        <li class="treeview">
