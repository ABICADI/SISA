        ...
        <div class="col-md-35 col-md-offset-0">
            ...
            <div class="form-group{{ $errors->has('descripcion') ? ' has-error' : '' }}">
                <label for="descripcion" class="col-md-2 control-label">Descripcion</label>
                    ...
                    <div class="col-md-6">
                        <textarea id="descripcion" class="form-control" name="descripcion" placeholder="descripcion" cols="50" rows="10"  type="text" value="{{ old('descripcion') }}" maxlength="1000" autofocus disabled></textarea>
                ...
                <label class="col-md-2 control-label"><label style="color:red">*</label> Fecha de la Actividad</label>
                    <div class="col-md-5">
                        <div class="input-group date">
                            ...
                            <input type="text" value="{{ old('fecha') }}" placeholder="30/01/1990" name="fecha" class="form-control pull-right" id="fecha2" required>
                        </div>
                    </div>
            </div>
