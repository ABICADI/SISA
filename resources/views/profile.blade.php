    ...
    <div class="row">
        <div class="col-md-47 col-md-offset-0">
            <div class="panel panel-default">
            	<div class="panel-heading" align="center"><p align="center"><img src="{{ asset("/bower_components/AdminLTE/dist/img/LOGO ABICADI 3.png") }}" alt="No Disponible" width="100" height="100"/></p></div>
